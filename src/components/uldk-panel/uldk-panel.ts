      ...
      >
        <vaadin-tabs slot="tabs">
          <vaadin-tab id="id-tab"
            >${i18next.t("id-tab-name", "Identyfikator")}</vaadin-tab
          >
          <vaadin-tab id="full-id-tab">Pełny identyfikator</vaadin-tab>
          <vaadin-tab id="coords-tab">Współrzędne</vaadin-tab>
        </vaadin-tabs>
        <div tab="id-tab"><uldk-id-tab .map=${this.map}></uldk-id-tab></div>
        <div tab="full-id-tab"><uldk-fullid-tab></uldk-fullid-tab></div>
        <div tab="coords-tab">Współrzędne</div>
      </vaadin-tabsheet>
    `;
  }
